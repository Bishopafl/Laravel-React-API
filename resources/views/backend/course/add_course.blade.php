            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Course Data</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="get" action="{{ route('add.courses') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="total_feature_one">
                                        @error('course_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="total_feature_two">
                                        @error('course_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="total_feature_three">
                                        @error('course_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="total_feature_four">
                                        @error('course_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="total_feature_five">
                                        @error('course_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row input-warning-o">
                                    <div class="col-sm-10">
                                        <input type="submit" class="btn btn-primary" value="Add Course Data">
                                    </div>
                                </div>
                            </form>
                        </div>
