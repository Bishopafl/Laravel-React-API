                        ...
                        <div class="basic-form">
                            <form method="post" action="{{ route('artworks.store') }}">
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="artwork_name" class="form-control">
                                        @error('artwork_name')
                                ...
                                <div class="form-group row input-warning-o">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="artwork_path">
                                        @error('artwork_path')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row input-warning-o">
                                    <div class="col-sm-10">
                                        <input type="submit" class="btn btn-primary" value="Add Artwork Data">
                                    </div>
                                </div>
                            </form>
                        </div>
