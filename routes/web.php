...
Route::prefix('chart')->group(function() {
    Route::get('/charts/all', [ChartController::class, 'AllCharts'])->name('all.charts');
    Route::get('/charts/add', [ChartController::class, 'AddCharts'])->name('add.charts');
    Route::post('/charts/store', [ChartController::class, 'StoreCharts'])->name('charts.store');
